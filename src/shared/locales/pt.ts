...
export const pt: Catalogue = {
  ...
  'overview.absences': 'Ausências',
  'overview.absencesUpcoming': 'Atuais e próximas',
  'overview.noAbsences': 'Sem ausências próximas',
  'overview.requested': 'Solicitada',
  'overview.oneDay': '1 dia',
  'overview.dayCount': '{count} dias',
  'overview.monthSheet': 'Folha de horas',
  'overview.monthWorked': 'Trabalhado este mês',
  'overview.targetToDate': 'Meta até hoje',
  'overview.targetMonth': 'Meta do mês',
  'overview.toComplete': '{count} por completar',
  'overview.loadFailed': 'Não foi possível carregar: {reason}',
  ...
  'timesheet.save': 'Solicitar alterações',
  'timesheet.discard': 'Descartar',
  'timesheet.saved': 'Alterações solicitadas',
  'timesheet.saveFailed': 'Não foi possível solicitar: {reason}',

  'timesheet.noChanges': 'Nada a solicitar',

  'timesheet.pendingHint': 'As alterações têm de ser aprovadas. Até lá o dia fica como está.',
  ...
  'timesheet.withdrawn': 'Pedido retirado',
