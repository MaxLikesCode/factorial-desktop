...
export const de: Catalogue = {
  ...
  'settingsPage.breakReminders': "Pausenerinnerungen",
  'settingsPage.breakDuration': "An laufende Pause erinnern nach",
  'settingsPage.breakDurationHint': "Eine Nachricht pro Pause. Du entscheidest, wann du weiterarbeitest.",
  'settingsPage.lunchTime': "An Mittagspause erinnern um",
  'settingsPage.lunchTimeHint': "Nur wenn heute noch keine Pause erfasst ist.",
  'settingsPage.lunchHours': "An Mittagspause erinnern nach",
  'settingsPage.lunchHoursHint': "Arbeitsstunden heute. Sind beide Auslöser aktiv, erinnert der erste einmal pro Tag.",
  'settingsPage.minutes': "{minutes} Min.",
  'breakReminder.lunchTitle': "Zeit für eine Pause",
  'breakReminder.lunchBody': "Du hast heute noch keine Pause erfasst. Wie wäre es mit einer Mittagspause?",
  'breakReminder.durationTitle': "Noch in Pause?",
  'breakReminder.durationBody': "Du bist seit {minutes} Minuten in Pause. Möchtest du weiterarbeiten?",
