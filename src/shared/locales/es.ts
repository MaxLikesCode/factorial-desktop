...
export const es: Catalogue = {
  ...
  'overview.absences': 'Ausencias',
  'overview.absencesUpcoming': 'Actuales y próximas',
  'overview.noAbsences': 'No hay ausencias próximas',
  'overview.requested': 'Solicitada',
  'overview.oneDay': '1 día',
  'overview.dayCount': '{count} días',
  'overview.monthSheet': 'Hoja de horas',
  'overview.monthWorked': 'Trabajado este mes',
  'overview.targetToDate': 'Objetivo hasta hoy',
  'overview.targetMonth': 'Objetivo del mes',
  'overview.toComplete': '{count} por completar',
  'overview.loadFailed': 'No se pudo cargar: {reason}',
  ...
  'timesheet.pending': 'Solicitado',

  'timesheet.pendingNew': 'Nuevo',

  'timesheet.pendingDelete': 'Eliminar',
  'timesheet.pendingLocation': 'Ubicación cambiada',
  'timesheet.afterApproval': 'tras la aprobación',
  ...
  'settingsPage.breakReminders': "Recordatorios de pausas",
  'settingsPage.breakDuration': "Recordar una pausa en curso tras",
  'settingsPage.breakDurationHint': "Una notificación por pausa. Tú decides cuándo volver.",
  'settingsPage.lunchTime': "Recordar el almuerzo a las",
  'settingsPage.lunchTimeHint': "Solo si hoy no hay ninguna pausa registrada.",
  'settingsPage.lunchHours': "Recordar el almuerzo tras",
  'settingsPage.lunchHoursHint': "Horas trabajadas hoy. Si activas ambos, el primero avisa una vez al día.",
  'settingsPage.minutes': "{minutes} min",
  'breakReminder.lunchTitle': "Hora de una pausa",
  'breakReminder.lunchBody': "Hoy no has registrado ninguna pausa. ¿Qué tal una pausa para almorzar?",
  'breakReminder.durationTitle': "¿Sigues de pausa?",
  'breakReminder.durationBody': "Llevas {minutes} minutos de pausa. ¿Quieres volver al trabajo?",
