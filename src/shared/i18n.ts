...
export const en = {
  ...
  // The app window, the tray entries that open it, and the long-shift notifications.
  'tray.openWindow': 'Open Factorial Desktop',
  'tray.timesheet': 'Timesheet …',
  'longShift.reminderTitle': 'Still clocked in',
  'longShift.reminderBody': 'You have been on the clock for {hours} hours. Forgot to clock out?',
  'longShift.clockedOutTitle': 'Clocked out automatically',
  'longShift.clockedOutBody': 'The shift ran past the limit you set. Check the timesheet and correct the time if needed.',
  'app.overview': 'Overview',
  'app.timesheet': 'Timesheet',
  'app.settings': 'Settings',
  'overview.today': 'Today',
  'overview.worked': 'Worked',
  'overview.target': 'Target',
  'overview.remaining': 'Remaining',
  'overview.breaks': 'Breaks',
  'overview.since': 'since {time}',
  'overview.location': 'Location',
  'overview.editToday': 'Edit today',
  'overview.stale': 'The last update failed — this is the last known state.',
  // The overview's other cards: absences and the month, as the profile page has them.
  'overview.absences': 'Absences',
  'overview.absencesUpcoming': 'Current and upcoming',
  'overview.noAbsences': 'No upcoming absences',
  'overview.requested': 'Requested',
  'overview.oneDay': '1 day',
  'overview.dayCount': '{count} days',
  'overview.monthSheet': 'Timesheet',
  'overview.monthWorked': 'Worked this month',
  'overview.targetToDate': 'Target to date',
  'overview.targetMonth': 'Month target',
  'overview.toComplete': '{count} to complete',
  'overview.loadFailed': 'Could not load: {reason}',
  'timesheet.thisMonth': 'This month',
  'timesheet.previousMonth': 'Previous month',
  'timesheet.nextMonth': 'Next month',
  ...
  'settingsPage.breakReminders': "Break reminders",
  'settingsPage.breakDuration': "Remind me during a break after",
  'settingsPage.breakDurationHint': "One notification per break. You choose when to resume.",
  'settingsPage.lunchTime': "Remind me to take lunch at",
  'settingsPage.lunchTimeHint': "Only if no break is recorded today.",
  'settingsPage.lunchHours': "Remind me to take lunch after",
  'settingsPage.lunchHoursHint': "Worked hours today. If both triggers are enabled, the first reminds you once per day.",
  'settingsPage.minutes': "{minutes} min",
  'breakReminder.lunchTitle': "Time for a break",
  'breakReminder.lunchBody': "You haven’t recorded a break today. How about a lunch break?",
  'breakReminder.durationTitle': "Still on a break?",
  'breakReminder.durationBody': "You have been on a break for {minutes} minutes. Ready to get back to work?",
  'settingsPage.general': 'General',
  'timePicker.title': "Choose time",
  'timePicker.hour': "Hour",
  'timePicker.minute': "Minute",
  'timePicker.apply': "Apply",
  'settingsPage.widget': 'Widget',
  'settingsPage.clockIn': 'Clocking in',
  'settingsPage.updates': 'Updates',
  'settingsPage.account': 'Account',
  'settingsPage.askLocation': 'Ask where I work before clocking in',
  'settingsPage.askLocationHint': 'Clock in opens a menu with office, home and business trip. Off, the last location is used.',
  'settingsPage.reminder': 'Remind me after',
  'settingsPage.reminderHint': 'A notification when a shift has been running this long.',
  'settingsPage.autoClockOut': 'Clock out automatically after',
  'settingsPage.autoClockOutHint': 'Writes a clock-out into the timesheet without asking. Off unless you switch it on.',
  'settingsPage.off': 'Off',
  'settingsPage.hours': '{hours} h',
  'settingsPage.signedInAs': 'Signed in',
} as const
